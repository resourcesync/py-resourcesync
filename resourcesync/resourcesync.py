...
class ResourceSync(Observable):
    ...
    def __init__(self, **kwargs):
        ...
        self.params = parameters.Parameters(**kwargs)
    ...
    def execute(self):
        ...
        if self.params.strategy == Strategy.resourcelist:
            ...
            executor = NewChangeListExecutor()
        elif self.params.strategy == Strategy.inc_changelist:
            executor = IncrementalChangeListExecutor()
        else:
    ...
    def get_resource_metadata(self):
        ...
        generator = self.params.generator(params=self.params, rsxml=self.rsxml)
